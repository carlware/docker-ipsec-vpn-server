...
L2TP_NET=${VPN_L2TP_NET:-'10.5.12.0/24'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'10.5.12.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'10.5.12.9-10.5.12.50'}
XAUTH_NET=${VPN_XAUTH_NET:-'10.5.13.0/24'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'10.5.13.9-10.5.13.50'}
